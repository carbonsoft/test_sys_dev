...
В кратце - написать unit-тест к функции func проверяющий что она работает правильно и написать в main.c вывод подсказки по аргументам, при передаче --help или просто неправильных аргументов.
...
2. Напишите команду для поиска в текстовом файле всех нечётных чисел от 1 до 100, записанных отдельным словом. Можно использовать заранее сгенерированные временные файлы.
